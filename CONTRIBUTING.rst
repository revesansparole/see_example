...
Ready to contribute? Here's how to set up `see_example` for local development.

1. Fork the `see_example` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/see_example.git
...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd see_example
    (dvlpt) see_example$ flake8
    (dvlpt) see_example$ nosetests
    (dvlpt) see_example$ tox
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/revesansparole/see_example/pull_requests
...
.. _issues: https://github.com/revesansparole/see_example/issues
