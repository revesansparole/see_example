...
_140478596986064 = CompositeNodeFactory(uid='b373ae3953da11e6907fd4bed973e64a',
                             ...
                             inputs=[],
                             outputs=[],
                             elt_factory={  2: ('openalea.see', 'load_data'),
   3: ('openalea.see', 'load_data'),
   5: ('openalea.see', 'log_to_see'),
   6: ('see.ex.expe1', 'mask')},
...
see_example_library_image_apply_mask = Factory(uid='b373ae3853da11e6907fd4bed973e64a',
                ...
                description='Apply a mask on an image. All masked pixels will '
                            'be black in the resulting image',
                category='Unclassified',
