...
to_hsv = Fa(uid="5fd5814a4f6511e690ec0242b2ebf0f7",
            name="to_hsv",
            description="Convert RGB image to HSV",
            category="",
            nodemodule="see_example.library.image",
            nodeclass="to_hsv",
            inputs=(dict(name="img", interface="IImage"),),
...
to_rgb = Fa(uid="5fd5814b4f6511e690ec0242b2ebf0f7",
            name="to_rgb",
            description="Convert HSV image to RGB",
            category="",
            nodemodule="see_example.library.image",
            nodeclass="to_rgb",
            inputs=(dict(name="img", interface="IImage"),),
...
lower = Fa(uid="eec8694c528011e6b255d4bed973e64a",
           name="lower",
           description="Convert pixel lower than threshold to black",
           category="",
           nodemodule="see_example.library.image",
           nodeclass="lower",
           inputs=(dict(name="img", interface="IImage"),
...
upper = Fa(uid="f2ef5332528011e6b255d4bed973e64a",
           name="upper",
           description="Convert pixel upper than threshold to white",
           category="",
           nodemodule="see_example.library.image",
           nodeclass="upper",
           inputs=(dict(name="img", interface="IImage"),
...
avg = Fa(uid="ccb6d026531311e6a55fd4bed973e64a",
         name="average",
         description="Compute average pixel value",
         category="",
         nodemodule="see_example.library.image",
         nodeclass="average",
         inputs=(dict(name="img", interface="IImage"),
